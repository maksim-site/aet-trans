...
<body class="theme-blue-v3 theme-v4 theme-v5 inner-page${bodyClass ? ` ${bodyClass}` : ""}">
${header(depth, active)}
  <main>${main}</main>${afterMain ? `\n${afterMain}` : ""}
${footer(depth)}
  <script src="${root}vendor/lenis.min.js?v=1"></script>
  <script src="${root}script.js?v=20260728-1"></script>
</body>
</html>
`;
}
...
console.log(`Generated the v5 preview and ${posts.length} news pages.`);
